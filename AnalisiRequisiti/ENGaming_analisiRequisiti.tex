...
Non viene fatta una distinzione tra un utente generico ed un utente autenticato poichè non si prevede che l'applicativo implementi un sistema di autenticazione.
...
\subsection{Requisiti di qualità}
    \begin{longtable}{|c|c|c|c|} 
        ...
        \hline    
        RQ04 & \makecell{Devono essere realizzati i test d'unità e di integrità} & Opzionale\\
        \hline
    \end{longtable}
