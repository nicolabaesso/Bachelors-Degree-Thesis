...
\end{lstlisting}
Questo comando manda un messaggio, di tipo \emph{gameIsOver}, con il punteggio conseguito.
\newpage
...
Tale gioco viene poi letto da un normale file \emph{Javascript} attraverso il file con estensione .wasm, che non permette di effettuare la modifica per la ricezione del punteggio, quindi per tali giochi non si possono avere record salvati.
